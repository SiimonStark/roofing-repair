    ...
    <div className={styles.container}>
      ...
      <div className={styles.briefing}>
        <article>
          <div>
            <p>
              Call us today at <a href='tel:+15418907680' style={{ "color": "white" }}>(541)890-7680</a> and we will walk you through your roofing system step by step.
            </p>
            <p>
      ...
      <div className={styles.callToAction}>
        <div></div>
        <h2>Call us today <a href='tel:+15418907680'>(541)890-7680</a></h2>
      </div>
